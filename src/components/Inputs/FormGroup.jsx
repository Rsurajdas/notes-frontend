  ...
  return (
    <div className="gap-custom-75 flex flex-col">
      ...
      <div className="relative w-full">
        {type === "search" ? (
          <span className="left-custom-200 absolute top-1/2 translate-y-[-50%]">
            <Search width="20" height="20" color="#717784" />
          </span>
        ) : null}
        <input
          type={show ? "text" : type}
