export default function Button({
  ...
  const styles =
    variant === "primary"
      ...
      : "bg-transparent text-custom-neutral-950 outline outline-custom-neutral-300 outline-offset-[-1px] hover:bg-custom-neutral-100 hover:text-custom-neutral-600 hover:outline-none focus:outline focus:shadow-custom-focus focus:outline-offset-[-1px] focus:outline-custom-neutral-950 focus:bg-custom-neutral-0 focus:text-custom-neutral-950";
  return (
    <button
      {...props}
      className={`inline-flex cursor-pointer rounded-custom-8 px-custom-200 py-custom-150 text-preset-4 disabled:bg-custom-neutral-100 disabled:text-custom-neutral-300 disabled:cursor-not-allowed disabled:outline-none items-center gap-2 group ${styles}`}
    >
      <>
        {Icon && (
          <span>
